...
const patientStats: StatCardProps[] = [
  {
    ...
    className: "bg-gradient-to-br from-blue-50 to-white hover:shadow-lg transition-shadow",
  },
  {
    ...
    footerLabel: "Ổn định",
    icon: IconUsers,
    className: "bg-gradient-to-br from-green-50 to-white hover:shadow-lg transition-shadow",
  },
  {
    title: "Hồ sơ y tế",
    value: 12,
    ...
    className: "bg-gradient-to-br from-purple-50 to-white hover:shadow-lg transition-shadow",
  },
  {
    ...
    className: "bg-gradient-to-br from-pink-50 to-white hover:shadow-lg transition-shadow",
  },
];
...
const quickActions: StatCardProps[] = [
  {
    ...
    icon: IconUsers,
    className: "cursor-pointer bg-gradient-to-br from-blue-100 to-white hover:bg-blue-200 transition-all",
  },
  {
    title: "Đặt Lịch Hẹn",
    value: "",
    ...
    icon: IconClipboardList,
    className: "cursor-pointer bg-gradient-to-br from-green-100 to-white hover:bg-green-200 transition-all",
  },
  {
    title: "Xem Hồ Sơ",
    value: "",
    ...
    icon: IconStethoscope,
    className: "cursor-pointer bg-gradient-to-br from-purple-100 to-white hover:bg-purple-200 transition-all",
  },
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
              ...
              <Card className="shadow-sm hover:shadow-md transition-shadow rounded-xl">
                <CardHeader className="border-b">
                  <CardTitle className="text-lg md:text-xl">Lịch Hẹn Sắp Tới</CardTitle>
                </CardHeader>
                  ...
                  {[
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="font-semibold text-base">{item.doctor}</div>
                        <Badge
                          variant={
                            item.status === "Đã xác nhận" ? "default" : "outline"
                          }
                          className={cn(
              ...
              <Card className="shadow-sm hover:shadow-md transition-shadow rounded-xl">
                <CardHeader className="border-b">
                  <CardTitle className="text-lg md:text-xl">Thao Tác Nhanh</CardTitle>
                </CardHeader>
                <CardContent className="pt-4 space-y-4">
              ...
              <Card className="shadow-sm hover:shadow-md transition-shadow rounded-xl">
                ...
                <CardContent className="pt-4">
                  <p className="text-sm text-muted-foreground mb-4">
                    Đã đến lúc uống thuốc huyết áp. Nhớ uống đúng giờ để đảm bảo hiệu quả điều trị.
                  </p>
                  <Button
                    variant="outline"
                    size="sm"
